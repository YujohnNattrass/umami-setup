...
class MyEcsConstructStack extends cdk.Stack {
  ...
  constructor(scope, id, props) {
    ...
    const cert = new cm.Certificate(this, "AbleUmamiCert", {
      domainName: 'test.yujohnnattrass.dev',
    ...
    new ecs_patterns.ApplicationLoadBalancedFargateService(this, "AbleUmami", {
